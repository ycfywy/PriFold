# -*- coding: utf-8 -*-
"""PriFold-SymFlow v4 discrete flow utilities.

v4 keeps the Bernoulli DFM objective, but adds:
  - direct score supervision for score-only projection;
  - pair-count/density calibration loss;
  - projection modes that can ignore the sampled candidate set and decode from scores.
"""
...
from symfold.v3.discrete_flow import (  # re-use stable v3 primitives
