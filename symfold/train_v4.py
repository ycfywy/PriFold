# -*- coding: utf-8 -*-
"""PriFold-SymFlow v4 training entry.

This file reuses the v3 training loop and swaps in the v4 model builder.
"""
...
from symfold.v4.model import PriFoldSymFlow_v4
...
def main():
    # Monkeypatch only at execution time so importing build_model from this
    # module does not mutate symfold.train_v3 for other tools.
