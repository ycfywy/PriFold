# -*- coding: utf-8 -*-
"""PriFold-SymFlow v5 model wrapper."""
...
from .da_se_dit import DASEDiT_MARS_v5
from .discrete_flow import (
    BernoulliFlowLoss_v6,
...
class PriFoldSymFlow_v5(nn.Module):
    """MARS-only SymFlow v5: stronger loss + larger model + anti-overprediction."""
    ...
    def __init__(self,
        ...
        self.flow_loss = BernoulliFlowLoss_v6(
            rho_0=rho_0,
            ...
            ratio_penalty_weight=ratio_penalty_weight,
            ratio_penalty_threshold=ratio_penalty_threshold,
        )
