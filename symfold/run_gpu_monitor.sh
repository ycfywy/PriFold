...
#
# 用法：
#   bash symfold/run_gpu_monitor.sh <task_name> [pid] [interval]
#
# 例：
#   bash symfold/run_gpu_monitor.sh v2_bprna 70242 5
#
# 参数：
...
TASK_NAME="${1:?usage: bash symfold/run_gpu_monitor.sh <task_name> [pid] [interval]}"
TRAIN_PID="${2:-}"
GPU_INTERVAL="${3:-5}"
